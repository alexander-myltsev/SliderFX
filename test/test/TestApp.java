    ...
    public void start(Stage primaryStage) {
        ...
        menu = new KiMenu()
                ...
                .section(new KiSection()
                        .title("Information")
                        .image(new Image(this.getClass().getResourceAsStream("Lectures/Lecture1/Slide1.PNG")))
                        .action(new KiAction()
                                .title("About component")
                                .onSelect(new KiJob() {
                                    @Override
                                    public void start() {
                                        alert("Component version is " + menu.version());
                                    }
                                }))
                        .action(new KiAction()
                                .title("About author")
                ...
                .section(new KiSection()
                        ...
                        .action(new KiAction()
                                ...
                                .onSelect(new KiJob() {
                                    @Override
                                    public void start() {
                                        menu.leftMargin(menu.leftMargin() - 10);
                                    }
                                }))
                        .action(new KiAction()
                ...
                .section(new KiSection()
                        ...
                        .action(new KiAction()
                                ...
                                .onSelect(new KiJob() {
                                    @Override
                                    public void start() {
                                        menu.iconHeight(menu.iconHeight() - 10);
                                    }
                                }))
                        .action(new KiAction()
                ...
                .section(new KiSection()
                        ...
                        .action(new KiAction()
                                ...
                                .onSelect(new KiJob() {
                                    @Override
                                    public void start() {
                                        menu.itemColor(Color.web("#ffffff"));
                                    }
                                }))
                        .action(new KiAction()
                                .title("Yellow")
                                .onSelect(new KiJob() {
                                    @Override
                                    public void start() {
                                        menu.itemColor(Color.web("#ffff99"));
                                    }
                                }))
                        .action(new KiAction()
                                .title("Cyan")
                                .onSelect(new KiJob() {
                                    @Override
                                    public void start() {
                                        menu.itemColor(Color.web("#99ffff"));
                                    }
                                })))
                .section(new KiSection()
                        .title("Items size")
                        ...
                        .action(new KiAction()
                                ...
                                .onSelect(new KiJob() {
                                    @Override
                                    public void start() {
                                        menu.itemHeight(menu.itemHeight() - 10);
                                    }
                                }))
                        .action(new KiAction()
                                .title("Increase height")
                ...
                .section(new KiSection()
                        ...
                        .action(new KiAction()
                                ...
                                .onSelect(new KiJob() {
                                    @Override
                                    public void start() {
                                        menu.titleColor(Color.web("#ffffff"));
                                    }
                                }))
                        .action(new KiAction()
                                .title("Yellow")
                                .onSelect(new KiJob() {
                                    @Override
                                    public void start() {
                                        menu.titleColor(Color.web("#ffff99"));
                                    }
                                }))
                        .action(new KiAction()
                                .title("Cyan")
                                .onSelect(new KiJob() {
                                    @Override
                                    public void start() {
                                        menu.titleColor(Color.web("#99ffff"));
                                    }
                                })))
                .section(new KiSection()
                        .title("Font size")
